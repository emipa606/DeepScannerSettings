...
public static class Utils
{
    ...
    public static bool Settings_ButtonLabeled(this Listing_Standard lister, string header, string buttonLabel,
        Color highlightingColor, float buttonWidth = 30f, bool background = true, bool active = true)
    {
        var anchor = Text.Anchor;
        var color = GUI.color;
    ...
    public static void Draw_Label(Rect rect, string label, Color highlight, Color color,
        GameFont fontSize = GameFont.Medium, TextAnchor anchor = TextAnchor.MiddleLeft)
    {
        var textSize = Text.Font;
        Text.Font = fontSize;
